...
public class AuthServiceImpl implements IAuthService {
    ...
    public AuthServiceImpl(IUserRepository userRepository, PasswordEncoder passwordEncoder, JwtTokenProvider jwtTokenProvider, AuthenticationManager authenticationManager, RedisService redisService) {
    ...
    @Override
    public UserDetailsDTO currentUser() {
        ...
        return UserDetailsDTO.fromCustomUserDetails((CustomUserDetails) authentication.getPrincipal());
    }
